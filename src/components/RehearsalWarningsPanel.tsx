...
import type { ActorScheduleConflict, RehearsalWarning } from '../utils/rehearsalInsights';
import {
...
export function RehearsalWarningsPanel({
  ...
  const visible = filterVisibleRehearsalWarnings(warnings, conflicts, dismissedIds);

  if (visible.warnings.length === 0 && visible.conflicts.length === 0) return null;
